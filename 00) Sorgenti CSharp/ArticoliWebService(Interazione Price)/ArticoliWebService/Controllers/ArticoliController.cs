...
using ArticoliWebService.Helpers;
...
namespace ArticoliWebService.Controllers
{
    ...
    public class ArticoliController : Controller
    {
        ...
        public async Task<IActionResult> GetArticoliByDesc(string filter, string IdList)
        {
        ...
        public IActionResult SaveArticoli([FromBody] Articoli articolo)
        {
            if (articolo == null)
            {
                return BadRequest(new InfoMsg(DateTime.Today, "E' necessario inserire i dati dell'articolo"));
            }
