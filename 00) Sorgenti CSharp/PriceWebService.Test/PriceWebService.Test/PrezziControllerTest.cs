...
using Models;
using PriceWebService.Controllers;
using PriceWebService.test;
using Services;
using Xunit;

namespace PriceWebService.Test
{
    [TestCaseOrderer("PriceWeService.Test.AlphabeticalOrderer", "PRICEWEBSERVICE.TEST")]
    public class PrezziControllerTest
    {
        ...
        public void C_TestDelPrezzo()
        {
            ...
            // Act
            var response = controller.DeletePrice("100","000028601") as ObjectResult;
            var value = response.Value as InfoMsg;
